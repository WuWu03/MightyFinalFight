...
//                    return false;
//                }
//                EditorUtils.SetEditorTexture(this._headerImg, 1, 512);
...
//                EditorUtils.SetEditorTexture(this._footerImg, 1, 256);
...
//                {
//                    Rect rect;
//                    rect..ctor(0f, 0f, this._headerSize.x, 30f);
...
//        {
//            Rect rect;
//            rect..ctor(0f, 30f, this._headerSize.x, this._headerSize.y);
...
//                this._src.safeModeOptions.nestedTweenFailureBehaviour = 0;
...
//            this._src.storeSettingsLocation = EditorGUILayout.Popup("Settings Location", this._src.storeSettingsLocation, this._settingsLocation, new GUILayoutOption[0]);
//            if (this._src.storeSettingsLocation != storeSettingsLocation)
//            {
//                if (this._src.storeSettingsLocation == 2 && EditorUtils.demigiantDir == null)
//                {
...
//                    if (storeSettingsLocation == 2)
//                    {
//                        this._src.storeSettingsLocation = 0;
//                        this.Connect(true);
//                    }
//                    else
//                    {
...
//            {
//                GUILayout.BeginVertical(GUI.skin.box, new GUILayoutOption[0]);
//                EditorGUI.BeginDisabledGroup(!this._src.useSafeMode && this._src.logBehaviour != 2);
