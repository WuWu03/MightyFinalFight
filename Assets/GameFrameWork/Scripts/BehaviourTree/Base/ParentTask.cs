...
namespace GameFrameWork.BehaviourTree
{
    ...
    {
        public ParentTask(string name, string args, object owner, int priority) : base(name, args, owner, priority)
        {
            m_Children = new List<Task>();
        ...
        private void SingleChild(float deltaTime)
        {
            ...
            Task child = m_Children[childIndex];
        ...
        private void ExcuteChild(Task child, int childIndex, float deltaTime)
        {
            child.Enter();
        ...
        private List<Task> m_Children = null;
    }
}