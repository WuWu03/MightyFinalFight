...
namespace GameFrameWork.UI
{
    public abstract class BasePanelCtrl
    {
        ...
        public void Open(GameFrameWorkAction callback = null,object[] param = null)
        {
            if (!m_IsInit)
            {
                Init(param);
        ...
        public void Close(GameFrameWorkAction callback)
        {
            if (!m_IsInit)
            {
                return;
        ...
        private void Init(object[] param)
        {
            ...
            m_ListOpenCallback = new List<GameFrameWorkAction>();
            m_ListCloseCallback = new List<GameFrameWorkAction>();
        ...
        private List<GameFrameWorkAction> m_ListOpenCallback = null;
        private List<GameFrameWorkAction> m_ListCloseCallback = null;
