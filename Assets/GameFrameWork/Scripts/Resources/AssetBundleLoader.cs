...
{
    public class AssetBundleLoader : GameFrameWorkEventArg
    {
        ...
        private GameFrameWorkFunc<string, AssetBundleInfo> m_GetLoadedAssetBundleFunc;
        private GameFrameWorkFunc<string, string[]> m_GetDependenciesFunc;
        private GameFrameWorkAction<AssetBundleLoader> m_OnLoadCompleteAction;

        public static AssetBundleLoader Create(string assetBundleName, string assetBundlePath, bool isDependence,
                                               GameFrameWorkFunc<string, AssetBundleInfo> getLoadedAssetBundleFunc,
                                               GameFrameWorkFunc<string, string[]> getDependenciesFunc,
                                               GameFrameWorkAction<AssetBundleLoader> m_OnLoadCompleteAction)
        {
