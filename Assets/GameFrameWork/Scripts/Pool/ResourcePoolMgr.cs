...
{
    public class ResourcePoolMgr : GameFrameWorkModule,IResourcePoolMgr
    {
        ...
        public void Get<T>(string assetPath, GameFrameWorkAction<string, UnityObject, object> loadedAction, object arg = null) where T : UnityObject
        {
            Get(assetPath, typeof(T), loadedAction, arg);
        }

        public void Get(string assetPath, Type assetType, GameFrameWorkAction<string, UnityObject, object> loadedAction, object arg = null)
        {
