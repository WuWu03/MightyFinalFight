...
namespace GameFrameWork.Editor
{
    public class FontMaker
    {
        ...
        public static void CreateMyFontSprite()
        {
            ...
            UnityEngine.Object[] sprites = AssetDatabase.LoadAllAssetsAtPath(selectionPath); //Resources.LoadAll<Sprite>(loadPath);
            if (sprites.Length > 0)
            {
                ...
                UnityEditor.EditorUtility.SetDirty(m_myFont);//设置变更过的资源  
