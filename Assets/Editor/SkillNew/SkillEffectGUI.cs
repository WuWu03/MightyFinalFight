...
namespace SkillNew
{
    public class SkillEffectGUI : SkillGUI
    {
        ...
        protected override void OnGUI()
        {
            ...
            //for (int i = 0; i < SkillEditorHelper2.currConfigData.SkillEffects.Length; i++)
            //{
            //    SkillConfigData.SkillEffect skillEffect = SkillEditorHelper2.currConfigData.SkillEffects[i];
            ...
            //        {
            //            SkillEditorHelper2.currConfigData.SkillEffects = CommonUtil.DeleteElement(SkillEditorHelper2.currConfigData.SkillEffects, i);
            ...
            //    SkillEditorHelper2.currConfigData.SkillEffects = CommonUtil.AddElement(SkillEditorHelper2.currConfigData.SkillEffects, new SkillConfigData.SkillEffect());
            //    return;
            //}
        }
        ...
        //    for (int i = 0; i < SkillEditorHelper2.currConfigData.SkillEffects.Length; i++)
        //    {
        //        m_ListSkillEffect.Add(Clone(SkillEditorHelper2.currConfigData.SkillEffects[i]));
        //    }
        }
        ...
        //{
            ...
            //    newSkillEffect.MoveTarget = source.MoveTarget;
            //    newSkillEffect.ScaleTarget = source.ScaleTarget;
