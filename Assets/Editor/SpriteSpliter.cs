...
public class SpriteSpliter : EditorWindow
{
    ...
    private string outPutPath = Application.dataPath + "/SplitSprite/";
    ...
    private void OnEnable()
    {
        ...
        SpriteSpliter window = (SpriteSpliter)EditorWindow.GetWindowWithRect(typeof(SpriteSpliter), wr, true, "TextureSpliter");
        window.Show();
    }
    ...
    private void SplitSprite()
    {
        ...
        if (selectionPath.StartsWith(resourcesPath))
        {
            ...
            textureImporterSettings.ApplyTextureType(TextureImporterType.Sprite, true);
            ...
            textureImporterSettings.textureFormat = TextureImporterFormat.RGB16;
