namespace WuWuFramework.Fsm
{
    public abstract class FsmState
    {
        ...
        public void SetStateData(Fsm fsm, FsmStateArg fsmStateArg)
        {
            OnSetStateData(fsm, fsmStateArg);
        }
        ...
        protected virtual void OnSetStateData(Fsm fsm, FsmStateArg fsmStateArg) { }
        protected void ChangeState<T>(Fsm fsm, FsmStateArg stateData = null) where T : FsmState
        {
            if (fsm == null)
            {
                return;
