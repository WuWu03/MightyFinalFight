...
namespace WuWuFramework.UI
{
    ...
    public class ScrollList : MonoBehaviour
    {
        ...
        public event WuWuFrameworkAction<BaseListItem> itemUpdateEvent;
        public event WuWuFrameworkFunc<int, Vector2> itemSizeEvent;
        ...
        private void OnEnable()
        {
            ...
            {
                throw new WuWuFrameworkException("[Scroll Rect] 组件不存在");
            }
        ...
        public void Init<T>() where T : BaseListItem
        {
            ...
            {
                throw new WuWuFrameworkException("ScrollRect组件设置异常");
            }
