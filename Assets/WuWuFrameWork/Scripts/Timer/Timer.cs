...
namespace WuWuFramework.Timer
{
    public class Timer : IReference
    {
        ...
        public static Timer Create(float duration, WuWuFrameworkAction onComplete, WuWuFrameworkAction<float> onUpdate, bool isLooped, bool usesRealTime)
        {
        ...
        private WuWuFrameworkAction m_OnComplete = null;
        private WuWuFrameworkAction<float> m_OnUpdate = null;
