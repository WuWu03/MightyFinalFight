...
namespace WuWuFramework.Map
{
    public static class AStar
    {
        ...
        private static List<Vector2Int> AStarPathFinding(Vector2Int from, Vector2Int to, Dictionary<Vector2Int, int> map, List<int> passTypes, WuWuFrameworkFunc<Vector2Int, Vector2Int, float> getDistance, WuWuFrameworkFunc<Vector2Int, Vector2Int[]> getNeighbors)
        {
        ...
        private static void FindDestNode(Vector2Int from, Vector2Int to, Node currNode, Dictionary<Vector2Int, int> map, List<int> passTypes, WuWuFrameworkFunc<Vector2Int, Vector2Int, float> getDistance, List<Node> openList, List<Node> closeList)
        {
        ...
        private static List<Vector2Int> CheckRange(Vector2Int point, int range, Dictionary<Vector2Int, int> map, List<int> passTypes, WuWuFrameworkFunc<Vector2Int, Vector2Int[]> getNeighbors)
        {
