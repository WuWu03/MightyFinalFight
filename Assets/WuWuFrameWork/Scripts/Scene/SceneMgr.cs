...
{
    public class SceneMgr : WuWuFrameworkModule, ISceneMgr
    {
        private event WuWuFrameworkAction<LoadSceneSuccessEventArgs> m_LoadSceneSuccessEvent;
        private event WuWuFrameworkAction<LoadSceneFailureEventArgs> m_LoadSceneFailureEvent;
        private event WuWuFrameworkAction<LoadSceneUpdateEventArgs> m_LoadSceneUpdateEvent;
