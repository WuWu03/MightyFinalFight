    ...
    public abstract class BaseMgr<T> : MonoBehaviour where T : BaseMgr<T>, new()
    {
        ...
        public static T instance
        {
            get
            {
                ...
                {
                    throw new WuWuFrameworkException(StringUtil.Append("[",typeof(T).Name, "] 没有实例，请先初始化该实例"));
                }
        ...
        public static void Init(GameObject manager)
        {
            ...
            {
                throw new WuWuFrameworkException(StringUtil.Append("[", typeof(T).Name, "] 实例已经存在，请不要重复实例化"));
            }
