...
namespace DragonBones.Demo
{
    ...
    public class Mecha
    {
        ...
        private AnimationState _aimState = null;
        private AnimationState _walkState = null;
        private AnimationState _attackState = null;
        ...
        public Mecha()
        {
            ...
            this._armatureComponent.AddDBEventListener(EventObject.FADE_IN_COMPLETE, this._OnAnimationEventHandler);
            this._armatureComponent.AddDBEventListener(EventObject.FADE_OUT_COMPLETE, this._OnAnimationEventHandler);
            this._armatureComponent.AddDBEventListener(EventObject.COMPLETE, this._OnAnimationEventHandler);

            //
            this._weaponL = this._armature.GetSlot("weapon_l").childArmature;
            this._weaponR = this._armature.GetSlot("weapon_r").childArmature;
            this._weaponL.eventDispatcher.AddDBEventListener(EventObject.FRAME_EVENT, this._OnFrameEventHandler);
            this._weaponR.eventDispatcher.AddDBEventListener(EventObject.FRAME_EVENT, this._OnFrameEventHandler);
        ...
        {
            this._weaponL.eventDispatcher.RemoveDBEventListener(EventObject.FRAME_EVENT, this._OnFrameEventHandler);
        ...
        {
            this._weaponR.eventDispatcher.RemoveDBEventListener(EventObject.FRAME_EVENT, this._OnFrameEventHandler);
    ...
    public class Bullet : MonoBehaviour
    {
        ...
        public void Init(string effectArmatureName, float radian, float speed)
        {
            ...
            rotation.z = -radian * Transform.RAD_DEG;
            ...
            if (effectArmatureName != null)
            {
                ...
                effectRotation.z = -radian * Transform.RAD_DEG;
