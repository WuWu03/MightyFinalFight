...
public class CameraMgr : BaseMgr<CameraMgr>
{
    ...
    public UnityEngine.Camera AddOrthographicCamera(string name, int depth, string tag, float orthographicSize,
        params string[] maskName)
    {
    ...
    public void SetFollowMode(CameraFollow.FollowMode followMode)
    {
        ...
        bool snapping = false, bool fadeOut = true)
    {
        ...
        m_CameraRoot.transform.DOShakePosition(duration, strength, vibrato, randomness, snapping, fadeOut)
