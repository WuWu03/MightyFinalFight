...
public class CameraFollow : MonoBehaviour
{
    ...
    public bool allowHorizontalAxisFollow { get; set; }


    public bool allowVerticalAxisFollow { get; set; }
    ...
    private Vector3 GetClampPos(Vector3 targetPos)
    {
        ...
        {
            m_CameraClamp.x = Mathf.Clamp(targetPos.x, m_Border.xMin > targetPos.x ? m_Border.xMin : targetPos.x,
                m_Border.xMax < targetPos.x ? m_Border.xMax : targetPos.x);
        }
        else
        {
            m_CameraClamp.x = 0;
        ...
        {
            m_CameraClamp.y = Mathf.Clamp(targetPos.y, m_Border.yMin > targetPos.y ? m_Border.yMin : targetPos.y,
                m_Border.yMax < targetPos.y ? m_Border.yMax : targetPos.y);
        }
        else
        {
            m_CameraClamp.y = 0;
