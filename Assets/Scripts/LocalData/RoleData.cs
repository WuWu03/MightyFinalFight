...
/// SheetName:Sheet1
/// </summary>
public class RoleData : BaseLocalData
{
	/// <summary>
	/// 名字
	/// </summary>
	...
	public RoleData Clone()
	{
		...
		roleData.assetName = this.assetName;
		roleData.hitEffect = this.hitEffect;
		roleData.headIcon = this.headIcon;
		roleData.attackSpeed = this.attackSpeed;
		roleData.moveSpeed = this.moveSpeed;
		roleData.jumpForce = this.jumpForce;
		roleData.attactIds = this.attactIds;
		roleData.jumpAttackIds = this.jumpAttackIds;
		roleData.catchAttackId = this.catchAttackId;
		roleData.throwAttackId = this.throwAttackId;
		roleData.weaponAttackId = this.weaponAttackId;
		roleData.throwWeaponId = this.throwWeaponId;
		roleData.skillIds = this.skillIds;
		roleData.attackWait = this.attackWait;
		roleData.attackNextTime = this.attackNextTime;
		roleData.weaponId = this.weaponId;
		roleData.isCatchControl = this.isCatchControl;
		roleData.behaviourTreeIds = this.behaviourTreeIds;
		roleData.hurtAnims = this.hurtAnims;
		roleData.isBoss = this.isBoss;
		return roleData;
	}
